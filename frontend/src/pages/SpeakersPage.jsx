...
const stats = [
  ...
  { value: 3, suffix: '', label: 'trilhas editoriais para encaixe de talks', icon: '🗺️', delay: 0.1 },
  { value: 48, suffix: 'h', label: 'de ativação intensa na semana do hackathon', icon: '⚡', delay: 0.2 },
  { value: 1, suffix: ' região', label: 'com baixa oferta de eventos tech desse porte', icon: '🗺️', delay: 0.3 },
    ...
    <>
      ...
      <main>
        <Hero
          ...
          subtitle="Se a sua atua??o ajuda pessoas e equipes a entender melhor o presente da tecnologia, a TechWeek 2026 pode ser o ambiente certo para transformar isso em conversa de alto valor."
          actions={[
